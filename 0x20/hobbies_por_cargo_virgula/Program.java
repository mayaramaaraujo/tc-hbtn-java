...
public class Program {
    public static void main(String[] args) {
        ...
        Map<String, String> pessoas1 = ConsultaPessoas.obterHobbiesPorCargoVirgula(todasPessoas);
        Map<String, String> pessoas2 = ConsultaPessoas.obterHobbiesPorCargoVirgula(
                List.of(pessoa1, pessoa2, pessoa3, pessoa4, pessoa9, pessoa10)
        );
        Map<String, String> pessoas3 = ConsultaPessoas.obterHobbiesPorCargoVirgula(
